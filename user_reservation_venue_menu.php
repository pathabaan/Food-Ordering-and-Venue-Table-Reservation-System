        ...
        <div class="card mx-auto" style="width: 49rem; background-color: #FFA07A">
            <div class="card-body">
              ...
              <button type="button" class="btn btn-secondary float-middle ml-4 mr-4"disabled><b>1. FORM ></b></button>
                  <button type="button" class="btn btn-secondary float-middle ml-4 mr-4"><b>2. MENU ></b></button>
              ...
              <div class="container mx-auto">
                  <div class="jumbotrons">
                        <hr class="my-4">
                        <h2>CHOOSE FROM OUR MENU</h2>
                        <a class="btn btn-primary mb-2 mt-3" href="user_reservation_venue_menuorder.php" role="button" aria-pressed="true">MENU</a>
                        <a class="btn btn-dark mb-2 mt-3" href="user_reservation_venue_form.php" role="button" aria-pressed="true">BACK</a>
                        <img src="pic\banner.jpg" class="rounded float-right border border-dark" style="width: 35rem;" alt="...">
                   </div>
                </div>
             </div>
            </div>
